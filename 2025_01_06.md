...
We will have conclusively decided that current approaches to AI (i.e. LLMS) will not produce AGI or ASI.
  ...
  <td>CPU/GPU on a chip ala apple silicon is the norm in all consumer computing, and has somewhat high enterprise/server penetration. Many applications that today do not take advantage of GPU availability are offloading work to them.</td>
</tr>
