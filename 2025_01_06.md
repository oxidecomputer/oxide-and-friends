...
<tr>
<td>
  Simon (more <a href="https://simonwillison.net/2025/Jan/10/ai-predictions/">on my blog</a>)
</td>
<td>
Agents will fail to happen, again. Lots of people will try to build AI assistants capable of acting autonomously on your behalf. Gullibity and reliability will render them useless, and a lot of investors will lose their shirts.
<hr>
... research assistants and code assistants (code/debug-in-a-loop) will continue to work great though.
</td>
<td>
Someone will win a Pulitzer for investigative reporting where LLM tools were part of their process.
<hr>
We'll get some privacy laws with teeth that govern things like training on input data from end-users - not federal, but may state or international.
</td>
<td>
Utopian: we'll get some really amazing art. Oscar winning films will use generative AI tools and it won't even be surprising or worth discussing. (Update: turns out Everything Everywhere All at Once <a href="https://simonwillison.net/2025/Jan/10/ai-predictions/#since-recording">used Runway ML already</a>)
<hr>
Dystopian: if AGI that can do almost any job a human can do emerges, the economic and civic impact will be really unpleasant.</td>
</tr>
</table>
...
<tr>
<td>
<a href="https://iangrunert.com/">Ian Grunert</a>
</td>
<td>
Ban on new sales of tp-link router hardware in the USA
<br><br>
OpenAI pricing or usage limit changes to prevent losing money on power users of their current flat monthly pricing schemas
</td>
<td>
<a href="https://en.wikipedia.org/wiki/Xserve">Apple Xserve</a> line returns / Apple starts selling server hardware again
</td>
<td>
Waymo overtakes Uber in rider miles per day
</td>
</tr>
