...
A:
> Bryan: "Elastic infrastructure is great and shouldn't be cloystered to the public cloud";
...
> Bryan: We can deliver more value with out own hypervisor;
...
> it is important to us the enable that ownership

> Steve: operator level and developer level;
> "Anythinh that we are injected ourselves into is [...] in the interest of making sure that the customer is getting a highly available and efficient system"
...
[@01:15:38] Interlude about lack of GPU support.
...
> No liquid cooling solution for now
...
> "To trust or to mistrust Oracle is to anthropomorphize Larry Ellison"
...
> The software is open (for the most part)
